<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="blogdetail.aspx.cs" Inherits="Site_de_Cinema.blogdetail" %>
...
<header class="ht-header">
	<div class="container">
				...
				<div class="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav flex-child-menu menu-left">
						...
						<li class="dropdown first">
							...
							Início <i class="fa fa-angle-down" aria-hidden="true"></i>
							</a>
							<ul class="dropdown-menu level1">
								<li><a href="index-2.html"> 01</a></li>
						...
						<li class="dropdown first">
							...
							Filmes<i class="fa fa-angle-down" aria-hidden="true"></i>
							</a>
							<ul class="dropdown-menu level1">
								<li class="dropdown">
						...
						<li class="dropdown first">
							<a class="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown">
							Atores <i class="fa fa-angle-down" aria-hidden="true"></i>
							</a>
							<ul class="dropdown-menu level1">
						...
						<li class="dropdown first">
							<a class="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown">
							Notícias <i class="fa fa-angle-down" aria-hidden="true"></i>
							</a>
							<ul class="dropdown-menu level1">
						...
						<li class="dropdown first">
							<a class="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown">
							Comunidade <i class="fa fa-angle-down" aria-hidden="true"></i>
							</a>
							<ul class="dropdown-menu level1">
					...
					<ul class="nav navbar-nav flex-child-menu menu-right">
						<li class="dropdown first">
							<a class="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown">
							Páginas <i class="fa fa-angle-down" aria-hidden="true"></i>
							</a>
							<ul class="dropdown-menu level1">
						...
						<li class="btn signupLink"><a href="#">Sign in</a></li>
					</ul>
				</div>
			<!-- /.navbar-collapse -->
	    </nav>
	    ...
	    <div class="top-search">
	    	<select>
				<option value="united">Filmes de TV</option>
			...
			<div class="col-md-12">
				<div class="hero-ct">
					...
					<ul class="breadcumb">
						...
						<li> <span class="ion-ios-arrow-right"></span> Lista de sites</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="blog-detail-ct">
					<h1>Novos posters dos personagens para os Piratas das Caraíbas</h1>
					<span class="time">27 Dezembro 2022</span>
					...
					<div class="comment-form">
						...
						<form action="#">
							...
							<div class="row">
								<div class="col-md-12">
									<textarea name="message" id="" placeholder="Mensagem"></textarea>
								</div>
							</div>
...
<footer class="ht-footer">
	<div class="container">
		<div class="flex-parent-ft">
			...
			<div class="flex-child-ft item5">
				<h4>Newsletter</h4>
				<p>Subscreva a nossa newsletter <br> para receber notícias mais recentes.</p>
				<form action="#">
	...
	<div class="ft-copyright">
		...
		<div class="backtotop">
			<p><a href="#" id="back-to-top">Voltar topo da página <i class="ion-ios-arrow-thin-up"></i></a></p>
		</div>
	</div>
</footer>
